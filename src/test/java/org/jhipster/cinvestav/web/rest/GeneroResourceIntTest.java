...
import org.jhipster.cinvestav.repository.GeneroRepository;
import org.jhipster.cinvestav.repository.search.GeneroSearchRepository;
...
public class GeneroResourceIntTest {
    ...
    private static final String DEFAULT_NGENERO = "AAAAAAAAAA";
    private static final String UPDATED_NGENERO = "BBBBBBBBBB";
    ...
    public void createGenero() throws Exception {
        ...
        assertThat(testGenero.getNgenero()).isEqualTo(DEFAULT_NGENERO);
    ...
    public void getAllGeneros() throws Exception {
        ...
        restGeneroMockMvc.perform(get("/api/generos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ngenero").value(hasItem(DEFAULT_NGENERO.toString())));
    }
    ...
    public void getGenero() throws Exception {
        ...
        restGeneroMockMvc.perform(get("/api/generos/{id}", genero.getId()))
            ...
            .andExpect(jsonPath("$.ngenero").value(DEFAULT_NGENERO.toString()));
    }
    ...
    public void updateGenero() throws Exception {
        ...
        Genero testGenero = generoList.get(generoList.size() - 1);
        assertThat(testGenero.getNgenero()).isEqualTo(UPDATED_NGENERO);
