package org.jhipster.cinvestav.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("eBorges");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("eBorges");
        ...
        config.getMapConfigs().put("org.jhipster.cinvestav.domain.*", initializeDomainMapConfig(jHipsterProperties));
